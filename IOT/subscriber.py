...
operacao_insert= "INSERT INTO dispositivo(mensagem,topico,qos,data_hora_medicao) VALUES(%s, %s, %s)"#Não altere muito aqui, mas se alterar, verifique o laço for com os dados do json
...
keepalive=60 
bind_address="" 
TOPIC=[("dataSet",0)]#tupla com tópico e QoS. Pode-se adicionar diversos tópicos e alterar o QoS caso queira 
